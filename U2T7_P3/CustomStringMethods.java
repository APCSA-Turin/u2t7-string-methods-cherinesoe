  ...
  // WRITE AND TEST THE METHODS BELOW
    ...
    */
    public String halvesReversed(String myString) {
        ...
        String second = myString.substring(myString.length() / 2, myString.length());
        return second + first;
    }
    ...
    */
    public String pigLatin(String orig) {
        ...
        String modified = orig.substring(1, orig.length()) + firstLetter + "ay";
        return modified;
    }
    ...
    */
    public String removeCharacter(String myString, int removeIdx) {
        if (removeIdx > myString.length() - 1) {
            ...
            String after = myString.substring(removeIdx + 1, myString.length());
            return before + after;
        }
    }
    ...
    */
    public String insertAt(String orig, String insertText, String searchStr) {
        ...
        if (insertIdx == -1) {
            ...
            String after = orig.substring(insertIdx, orig.length());
            String newString = before + insertText + after;
            return newString;
        }
    }
    ...
    */
    public String endUp(String myString, int numToCap){
        if (numToCap > myString.length()) {
            ...
            String before = myString.substring(0, myString.length() - numToCap);
            String after = myString.substring(myString.length() - numToCap, myString.length()).toUpperCase();
            return before + after;
        }
    }
    ...
    */
    ...
    public String starBetween(String myString) {
        ...
        while (idx < myString.length() - 1) {
            starredString += (myString.substring(idx, idx + 1));
            starredString += ("*");
            idx += 1;
        }
        starredString += myString.substring(idx, myString.length());
